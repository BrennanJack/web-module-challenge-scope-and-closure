...
/*Task 1: counterMaker()
  ...
  1. What is the difference between counter1 and counter2?
    counter1 is a reusable, self-contained function, whereas counter2 uses and modifies a global count variable.
  2. Which of the two uses a closure? How can you tell?
    counter1 uses a closure because the internal counter function accesses the info in the counterMaker function.
  
  3. In what scenario would the counter1 code be preferable? In what scenario would 
     counter2 be better?  
      counter 1 would be preferable if you wanted to be able to invoke the function multiple times for different uses, where counter 2 would be preferable when you want to increment a global variable for use elsewhere.
*/
